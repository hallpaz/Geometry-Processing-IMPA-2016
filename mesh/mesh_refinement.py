...
def mesh_refinement(triangles, vertices, normals, indices_map, implicit_function, num_iterations = 1):
    ...
    for i in range(num_iterations):
        for t in triangles:
            ...
            n1 = ((normals[t.a] + normals[t.b])/2)
            n2 = ((normals[t.b] + normals[t.c])/2)
            n3 = ((normals[t.a] + normals[t.c])/2)

            #projection
            v1 = projection( implicit_function(v1 + t*n1) )
            v2 = projection()
            v3 = projection()
